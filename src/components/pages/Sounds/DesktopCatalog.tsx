    ...
    <div className='w-full pt-20 lg:pt-12 justify-center items-center mx-auto'>
      <div className='flex max-w-screen-xl pl-2 lg:px-4 mx-auto flex-col relative'>
        {tracks.map((track: Track, index: number) => (
          <div
            key={track.id}
            className='flex p-1 border-neutral-300 hover:bg-neutral-100 dark:border-neutral-800 group dark:hover:bg-neutral-900 border-b justify-center items-center rounded-lg pr-12 relative h-18'
          ...
          >
            ...
            <div className='flex flex-row justify-between w-full ml-2'>
              ...
              <div className='grid grid-cols-5 items-center justify-center gap-8 w-72 mr-2'>
                <div className='col-span-1'>
                  <div className='mr-8 justify-center items-center'>
                    <p className='text-black dark:text-neutral-400 text-xs'>
                ...
                <div className='flex-col col-span-2'>
                  {renderValue(track?.info?.genre[0]?.maingenre) && (
                    <div className='flex justify-center items-center'>
                      <p className='text-center text-white bg-blue-200 dark:bg-blue-900 text-xs px-2 py-0.5 mb-1 rounded-md w-auto'>
                        {renderValue(track.info.genre[0].maingenre)}
                      </p>
                    </div>
                  )}
